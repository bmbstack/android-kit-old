...
public class OkHttpClientManager {
    ...
    public static OkHttpClientManager getInstance() { //线程安全,双重校验
        if (mInstance == null) {
    ...
    public void execute(final Request request, DataCallback callback) {
        if (callback == null) {
            callback = DataCallback.DEFAULT_RESULT_CALLBACK;
        }
        final DataCallback resCallBack = callback;
    ...
    public void sendFailResultCallback(final Request request, final Exception e, final DataCallback callback) {
    ...
    public void sendSuccessResultCallback(final Object object, final DataCallback callback) {
        if (callback == null) return;
        mHandler.post(new Runnable() {
            @Override
            public void run() {
